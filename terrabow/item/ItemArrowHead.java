...
public class ItemArrowHead extends ItemTerra{
	
	public Icon[] icons;

	public ItemArrowHead( int id ){
		super( id );
		this.setMaxStackSize( TerraBowSettings.StackLimitArrowHeads );
	...
	public void updateIcons( IconRegister iconRegister ){
		for( int i = 0; i < this.icons.length; i++ ){
			this.icons[i] = iconRegister.registerIcon( "arrowheads/ArrowHead" + this.MetaNames[i].replaceAll( "\\s", "" ) );
		}
	}
	@Override
